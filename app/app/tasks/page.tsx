  ...
  return (
    <div className="space-y-6">
      <section className="space-y-2 pt-3">
        <p className="text-sm text-[var(--muted)]">{copy.tasks.section}</p>
        <h1 className="text-3xl font-semibold">{copy.tasks.title}</h1>
        <p className="max-w-2xl text-sm leading-6 text-[var(--muted)]">{copy.tasks.intro}</p>
      </section>
